...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: NewAssessmentWidget.routeName,
  ...
  builder: (context, params) => AssessmentResultWidget(
    ...
    feelingAfter: params.getParam('feelingAfter', ParamType.int),
        ...
        FFRoute(
          ...
          builder: (context, params) => const FitnessProgressWidget(),
        ),
        FFRoute(
          name: HistoryLogWidget.routeName,
          path: HistoryLogWidget.routePath,
          builder: (context, params) => const HistoryLogWidget(),
        ),
        FFRoute(
...
extension NavParamExtensions on Map<String, dynamic> {
...
class FFParameters {
  ...
  Future<bool> completeFutures() => Future.wait(
        state.allParams.entries.where(isAsyncParam).map(
          (param) async {
            final doc =
                await asyncParams[param.key]!(param.value).onError((_, __) {
              return null;
            });
  ...
  dynamic getParam(
    ...
    return deserializeParam(param, type, isList);
  }
}
